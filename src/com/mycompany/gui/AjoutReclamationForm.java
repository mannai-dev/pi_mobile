...
import com.mycompany.utils.EmailProfil;
...
Display.getInstance().scheduleLocalNotification(
        ...
        try{
            ...
            Dialog.show("Veuillez verifier les donnees","", "Annuler", "OK");
                ...
                Reclamation r=new Reclamation(String.valueOf(title.getText()).toString()
        ...
        fab.createSubFAB(FontImage.MATERIAL_IMPORT_CONTACTS, "envoie mail").addActionListener(e -> {
            ...
            EmailProfil m = new EmailProfil(res);
            hi.add(m.createDemo(res));
            hi.show();
