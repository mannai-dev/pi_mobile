...
public class PanierForm extends BaseForm {
    ...
    public PanierForm(Resources res) {
        ...
        ArrayList<Panier> list = ServicePanier.getInstance().CartList();
        for (Panier rec : list) {
    ...
    private void addButton(Image img, Panier rec, Resources res) {
        ...
        Label idTxt = new Label("Ref : " + rec.getId_product());
        Label nameTxt = new Label("Product : miel");
        Label qntTxt = new Label("Quantity : " + rec.getQuantity());
        ...
        lSupp.addPointerPressedListener((l) -> {
            ...
            if (dig.show("Delete", "Vous voulez supprimer ce produit ?", "Annuler", "Oui")) {
                ...
                dig.dispose();
                //Appel
                if (ServicePanier.getInstance().deleteProd(rec.getId_panier())) {
