...
public class PlanningService {
    ...
    public boolean addPlanningAction(Planning p ){
        ...
        String url = Statics.BASE_URL + "/addPlanningJSON/new?"+"idCoach="+ p.getId_coach ()+ "&coachName=" + p.getCoach_name()+ "&course=" +p.getCourse()+ "&startlesson=" +p.getStartLesson()+ "&endlesson=" +p.getEndLesson()+ "&maxnbr=" +p.getMaxNbr()+ "&nbractuel=" +p.getNbractuel();
        req.setUrl(url);
        req.setPost(false);
       ...
       public boolean deleteItem(int idPlanning) {
        String url = Statics.BASE_URL + "/deletePlanningJSON/"+idPlanning;
                 //création de l'URL
    ...
    public ArrayList<Planning> getPlannings(){
         ...
         String url = Statics.BASE_URL+"/Allplanning";
